...
using Naspinski.FoodTruck.AdminWeb.Models.ManageViewModels;
...
namespace Naspinski.FoodTruck.AdminWeb.Controllers
{
    ...
    public class ManageController : _BaseFoodTruckController
    {
            ...
            AzureSettings azureSettings) : base(context)
        {
            ...
            _fromEmail = new Query.Settings.Get(_context, 
                new List<string>() { SettingName.ContactEmail })
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            await _emailSender.SendEmailConfirmationAsync(_azureSettings.SendgridApiKey, email, _fromEmail, callbackUrl);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Naspinski.FoodTruck.AdminWeb"),
